...
export default function App() {
  ...
  const handleOpenBuilder = useCallback(() => { setStep('builder'); setSelectedTheme(null); }, []);
  ...
  const handleBackFromBuilder = useCallback(() => { setStep(2); }, []);
  ...
  const stepNum = step === 'builder' ? 2 : step;
              ...
              <div key={n} style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                ...
                {n < 3 && (
                  <div style={{
                    ...
                    background: stepNum > n ? 'var(--a2)' : 'var(--border2)',
